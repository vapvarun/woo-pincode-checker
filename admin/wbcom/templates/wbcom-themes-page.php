<div class="wrap">
	...
	<div class="reign-demos-wrapper">
		<h4 class="wbcom-demo-name"><?php esc_html_e( 'Reign BuddyPress', 'woo-pincode-checker' ); ?></h4>
		...
		<h4 class="wbcom-demo-name"><?php esc_html_e( 'LearnMate', 'woo-pincode-checker' ); ?></h4>
		<div class="wbcom-demo-content-wrap">
			<div class="wbcom-demo-importer">
				<div class="container">
					<div class="wbcom-image-wrapper">
		...
		<h4 class="wbcom-demo-name"><?php esc_html_e( 'StoreMate', 'woo-pincode-checker' ); ?></h4>
		<div class="wbcom-demo-content-wrap">
			<div class="wbcom-demo-importer">
				<div class="container">
					<div class="wbcom-image-wrapper">
		...
		<h4 class="wbcom-demo-name"><?php esc_html_e( 'Jobmate', 'woo-pincode-checker' ); ?></h4>
		<div class="wbcom-demo-content-wrap">
			<div class="wbcom-demo-importer">
				<div class="container">
					<div class="wbcom-image-wrapper">
