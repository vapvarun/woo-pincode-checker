            ...
            <div class="wbcom-welcome-support-info">
                ...
                <div class="three-col">
                    ...
                    <div class="col">
                        ...
                        <a href="<?php echo esc_url( 'https://wbcomdesigns.com/docs/woo-addons/woo-pincode-checker/' ); ?>" class="button button-primary button-welcome-support" target="_blank"><?php esc_html_e( 'Read Documentation', 'woo-pincode-checker' ); ?></a>
                    </div>
