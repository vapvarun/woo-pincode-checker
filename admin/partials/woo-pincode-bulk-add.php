		...
		if ( is_wp_error( $pincodes ) ) {
			...
			if ( $total_pincodes > 1000 ) {
				...
				if ( $auto_geocode ) {
					$wpc_message = sprintf(
						// Translators: %s is a placeholder value.
						__( 'Bulk add completed! Added: %1$d, Skipped: %2$d, Errors: %3$d, Auto-geocoded: %4$d', 'pincode-checker-for-woocommerce' ),
						$added,
						$skipped,
						$error_count,
						$geocoded
					...
					$wpc_message = sprintf(
						// Translators: %s is a placeholder value.
						__( 'Bulk add completed! Added: %1$d, Skipped (already exists): %2$d, Errors: %3$d', 'pincode-checker-for-woocommerce' ),
						$added,
						$skipped,
						$error_count
					);
